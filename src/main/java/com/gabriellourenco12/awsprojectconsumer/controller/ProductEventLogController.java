package com.gabriellourenco12.awsprojectconsumer.controller;

import com.gabriellourenco12.awsprojectconsumer.model.ProductEventLogDto;
...
public class ProductEventLogController {
    ...
    public List<ProductEventLogDto> findByCodeAndEvent(@PathVariable String code, @PathVariable String event) {
